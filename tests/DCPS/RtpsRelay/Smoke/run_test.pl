...
$test->process("relay1", "$ENV{DDS_ROOT}/bin/RtpsRelay", "-ReportStatistics 1 -DCPSConfigFile relay1.ini -ApplicationDomain 42 -VerticalAddress 4444 -HorizontalAddress 127.0.0.1:11444 -UserData relay1 -StatisticsInterval 3" . $relay_security_opts);
